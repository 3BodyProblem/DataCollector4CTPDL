...
void CTPQuoImage::BuildBasicData()
{
	...
	QuoCollector::GetCollector()->OnImage( 100, (char*)&tagMkInfo, sizeof(tagDLFutureMarketInfo_LF100), true );
	QuoCollector::GetCollector()->OnImage( 102, (char*)&tagStatus, sizeof(tagDLFutureMarketStatus_HF102), true );
}
	...
	if( NULL != pInstrument )
	{
		...
		{	///< 判断为是否需要过滤的商品
			...
			else
			{
				...
				tagDLFutureKindDetail_LF101&		refKind = m_mapKind[sCodeKey];
				...
				QuoCollector::GetCollector()->OnImage( 101, (char*)&refKind, sizeof(tagDLFutureKindDetail_LF101), true );
